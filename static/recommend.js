...
function load_details(my_api_key,title){
  $.ajax({
    type: 'GET',
    url:'https://api.codetabs.com/v1/proxy?quest=' + encodeURIComponent('https://api.themoviedb.org/3/search/movie?api_key='+my_api_key+'&query='+title),
...
function get_movie_details(movie_id,my_api_key,arr,movie_title) {
  $.ajax({
    type:'GET',
    url:'https://api.codetabs.com/v1/proxy?quest=' + encodeURIComponent('https://api.themoviedb.org/3/movie/'+movie_id+'?api_key='+my_api_key),
...
function get_individual_cast(movie_cast,my_api_key) {
    ...
    for(var cast_id in movie_cast.cast_ids){
      $.ajax({
        type:'GET',
        url:'https://api.codetabs.com/v1/proxy?quest=' + encodeURIComponent('https://api.themoviedb.org/3/person/'+movie_cast.cast_ids[cast_id]+'?api_key='+my_api_key),
        async:false,
...
function get_movie_cast(movie_id,my_api_key){
    ...
    $.ajax({
      type:'GET',
      url:"https://api.codetabs.com/v1/proxy?quest=" + encodeURIComponent("https://api.themoviedb.org/3/movie/"+movie_id+"/credits?api_key="+my_api_key),
      async:false,
...
function get_movie_posters(arr,my_api_key){
  ...
  for(var m in arr) {
    $.ajax({
      type:'GET',
      url:'https://api.codetabs.com/v1/proxy?quest=' + encodeURIComponent('https://api.themoviedb.org/3/search/movie?api_key='+my_api_key+'&query='+arr[m]),
      async: false,
